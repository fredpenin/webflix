            ...
            <div class="col-sm-6 col-md-3 col-lg-2">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="movie_edit.php?id=<?php echo $movie['id_mov']; ?>" class="btn btn-block btn-warning">Modifier</a>
                        <a href="movie_delete.php?id=<?php echo $movie['id_mov']; ?>" class="btn btn-block btn-danger">Supprimer</a>
                    </div>
                </div>
            </div>
            <?php } ?>
